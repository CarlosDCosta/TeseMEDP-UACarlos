...
def command_created(args: adsk.core.CommandCreatedEventArgs):
    ...
    #Criar Input Slider
    DiaBaseSlider = inputs.addFloatSliderCommandInput('slider_diametro_base', 'Slider para diâmetro da base', 'mm', 5,29,False)
    DiaBaseSlider.valueOne = DiaBaseParam.value
    DiaPriSlider = inputs.addFloatSliderCommandInput('slider_primeiro_diametro', 'Slider para o diâmetro da base-centro','mm', 5, 29, False)
    DiaPriSlider.valueOne = DiaPriParam.value
    DiaSegSlider = inputs.addFloatSliderCommandInput('slider_segundo_diametro', 'Slider para o diâmetro do centro', 'mm', 5, 29, False)
    DiaSegSlider.valueOne = DiaSegParam.value
    DiaTerSlider = inputs.addFloatSliderCommandInput('slider_terceiro_diametro', 'Slider para o diâmetro do centro-topo', 'mm', 5, 29, False)
    DiaTerSlider.valueOne = DiaTerParam.value
    DiaTopoSlider = inputs.addFloatSliderCommandInput('slider_diametro_topo', 'Slider para diâmetro do topo', 'mm', 5, 29, False)
    DiaTopoSlider.valueOne = DiaTopoParam.value



    AltBaseSlider = inputs.addFloatSliderCommandInput('slider_altura_base', 'Slider para a altura da base', 'mm', 0,39,False)
    AltBaseSlider.valueOne = AltBaseParam.value
    AltPriSlider = inputs.addFloatSliderCommandInput('slider_primeira_altura', 'Slider para a altura da base-centro','mm', 0, 39, False)
    AltPriSlider.valueOne = AltPriParam.value
    AltSegSlider = inputs.addFloatSliderCommandInput('slider_segunda_altura', 'Slider para a altura do centro', 'mm', 0, 39, False)
    AltSegSlider.valueOne = AltSegParam.value
    AltTerSlider = inputs.addFloatSliderCommandInput('slider_terceira_altura', 'Slider para a altura do centro-topo', 'mm', 0, 39, False)
    AltTerSlider.valueOne = AltTerParam.value
    AltTopoSlider = inputs.addFloatSliderCommandInput('slider_altura_topo', 'Slider para a altura do topo', 'mm', 0, 39, False)
    AltTopoSlider.valueOne = AltTopoParam.value

    DispBaseSlider = inputs.addFloatSliderCommandInput('slider_dispersao_base', 'Slider para a dispersão da base', 'mm', 0,5, False)
    DispBaseSlider.valueOne = DispBaseParam.value
    DispPriSlider = inputs.addFloatSliderCommandInput('slider_primeira_dispersao', 'Slider para a dispersão da base-centro','mm', 0, 5, False)
    DispPriSlider.valueOne = DispPriParam.value
    DispSegSlider = inputs.addFloatSliderCommandInput('slider_segunda_dispersao', 'Slider para a dispersão do centro', 'mm', 0, 5, False)
    DispSegSlider.valueOne = DispSegParam.value
    DispTerSlider = inputs.addFloatSliderCommandInput('slider_terceira_dispersao', 'Slider para a dispersão do centro-topo', 'mm', 0, 5, False)
    DispTerSlider.valueOne = DispTerParam.value
    DispTopoSlider = inputs.addFloatSliderCommandInput('slider_dispersao_topo', 'Slider para a dispersão do topo', 'mm', 0, 5, False)
